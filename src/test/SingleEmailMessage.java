    ...
    extends Email
{
    ...
    @XmlElementRef(name = "inReplyTo", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> inReplyTo;
    @XmlElement(required = true, nillable = true)
    @XmlSchemaType(name = "string")
    protected SendEmailOptOutPolicy optOutPolicy;
    @XmlElementRef(name = "orgWideEmailAddressId", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> orgWideEmailAddressId;
    @XmlElement(required = true, nillable = true)
    protected String plainTextBody;
    @XmlElementRef(name = "references", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)

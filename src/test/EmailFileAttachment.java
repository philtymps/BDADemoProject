...
public class EmailFileAttachment {
    ...
    @XmlElementRef(name = "body", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> body;
    @XmlElementRef(name = "contentType", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)

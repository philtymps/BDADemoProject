...
public class PerformQuickActionResult {
    ...
    @XmlElementRef(name = "successMessage", namespace = "urn:partner.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> successMessage;
     ...
     *     
     */
    public JAXBElement<String> getSuccessMessage() {
     ...
     *     
     */
    public void setSuccessMessage(JAXBElement<String> value) {

...
public class StatusCode implements java.io.Serializable {
    ...
    public static final java.lang.String _CANNOT_CHANGE_FIELD_TYPE_OF_REFERENCED_FIELD = "CANNOT_CHANGE_FIELD_TYPE_OF_REFERENCED_FIELD";
    ...
    public static final java.lang.String _CANNOT_EXECUTE_FLOW_TRIGGER = "CANNOT_EXECUTE_FLOW_TRIGGER";
    public static final java.lang.String _CANNOT_FREEZE_SELF = "CANNOT_FREEZE_SELF";
    ...
    public static final java.lang.String _CANNOT_PASSWORD_LOCKOUT = "CANNOT_PASSWORD_LOCKOUT";
    ...
    public static final java.lang.String _CANNOT_RENAME_REFERENCED_FIELD = "CANNOT_RENAME_REFERENCED_FIELD";
    public static final java.lang.String _CANNOT_RENAME_REFERENCED_OBJECT = "CANNOT_RENAME_REFERENCED_OBJECT";
    ...
    public static final java.lang.String _COLLISION_DETECTED = "COLLISION_DETECTED";
    public static final java.lang.String _COMMUNITY_NOT_ACCESSIBLE = "COMMUNITY_NOT_ACCESSIBLE";
    public static final java.lang.String _CUSTOM_APEX_ERROR = "CUSTOM_APEX_ERROR";
    ...
    public static final java.lang.String _DELETE_OPERATION_TOO_LARGE = "DELETE_OPERATION_TOO_LARGE";
    ...
    public static final java.lang.String _ENVIRONMENT_HUB_MEMBERSHIP_ERROR_JOINING_HUB = "ENVIRONMENT_HUB_MEMBERSHIP_ERROR_JOINING_HUB";
    public static final java.lang.String _ENVIRONMENT_HUB_MEMBERSHIP_USER_ALREADY_IN_HUB = "ENVIRONMENT_HUB_MEMBERSHIP_USER_ALREADY_IN_HUB";
    public static final java.lang.String _ENVIRONMENT_HUB_MEMBERSHIP_USER_NOT_ORG_ADMIN = "ENVIRONMENT_HUB_MEMBERSHIP_USER_NOT_ORG_ADMIN";
    ...
    public static final java.lang.String _INVALID_OAUTH_URL = "INVALID_OAUTH_URL";
    ...
    public static final java.lang.String _INVALID_OWNER = "INVALID_OWNER";
    ...
    public static final java.lang.String _INVALID_SIGNUP_COUNTRY = "INVALID_SIGNUP_COUNTRY";
    public static final java.lang.String _INVALID_STATUS = "INVALID_STATUS";
    public static final java.lang.String _INVALID_SUBDOMAIN = "INVALID_SUBDOMAIN";
    ...
    public static final java.lang.String _NO_SUCH_USER_EXISTS = "NO_SUCH_USER_EXISTS";
    ...
    public static final java.lang.String _PACKAGING_API_INSTALL_FAILED = "PACKAGING_API_INSTALL_FAILED";
    public static final java.lang.String _PACKAGING_API_UNINSTALL_FAILED = "PACKAGING_API_UNINSTALL_FAILED";
    ...
    public static final java.lang.String _SELF_REFERENCE_FROM_FLOW = "SELF_REFERENCE_FROM_FLOW";
    ...
    public static final java.lang.String _SUBDOMAIN_IN_USE = "SUBDOMAIN_IN_USE";
    ...
    public static final java.lang.String _TOO_MANY_POSSIBLE_USERS_EXIST = "TOO_MANY_POSSIBLE_USERS_EXIST";
    ...
    public static final java.lang.String _WEBLINK_URL_INVALID = "WEBLINK_URL_INVALID";
    ...
    public static final StatusCode CANNOT_CHANGE_FIELD_TYPE_OF_REFERENCED_FIELD = new StatusCode(_CANNOT_CHANGE_FIELD_TYPE_OF_REFERENCED_FIELD);
    ...
    public static final StatusCode CANNOT_EXECUTE_FLOW_TRIGGER = new StatusCode(_CANNOT_EXECUTE_FLOW_TRIGGER);
    public static final StatusCode CANNOT_FREEZE_SELF = new StatusCode(_CANNOT_FREEZE_SELF);
    ...
    public static final StatusCode CANNOT_PASSWORD_LOCKOUT = new StatusCode(_CANNOT_PASSWORD_LOCKOUT);
    ...
    public static final StatusCode CANNOT_RENAME_REFERENCED_FIELD = new StatusCode(_CANNOT_RENAME_REFERENCED_FIELD);
    public static final StatusCode CANNOT_RENAME_REFERENCED_OBJECT = new StatusCode(_CANNOT_RENAME_REFERENCED_OBJECT);
    ...
    public static final StatusCode COLLISION_DETECTED = new StatusCode(_COLLISION_DETECTED);
    public static final StatusCode COMMUNITY_NOT_ACCESSIBLE = new StatusCode(_COMMUNITY_NOT_ACCESSIBLE);
    public static final StatusCode CUSTOM_APEX_ERROR = new StatusCode(_CUSTOM_APEX_ERROR);
    ...
    public static final StatusCode CUSTOM_METADATA_LIMIT_EXCEEDED = new StatusCode(_CUSTOM_METADATA_LIMIT_EXCEEDED);
    ...
    public static final StatusCode DELETE_OPERATION_TOO_LARGE = new StatusCode(_DELETE_OPERATION_TOO_LARGE);
    ...
    public static final StatusCode ENVIRONMENT_HUB_MEMBERSHIP_CONFLICT = new StatusCode(_ENVIRONMENT_HUB_MEMBERSHIP_CONFLICT);
    public static final StatusCode ENVIRONMENT_HUB_MEMBERSHIP_ERROR_JOINING_HUB = new StatusCode(_ENVIRONMENT_HUB_MEMBERSHIP_ERROR_JOINING_HUB);
    public static final StatusCode ENVIRONMENT_HUB_MEMBERSHIP_USER_ALREADY_IN_HUB = new StatusCode(_ENVIRONMENT_HUB_MEMBERSHIP_USER_ALREADY_IN_HUB);
    public static final StatusCode ENVIRONMENT_HUB_MEMBERSHIP_USER_NOT_ORG_ADMIN = new StatusCode(_ENVIRONMENT_HUB_MEMBERSHIP_USER_NOT_ORG_ADMIN);
    ...
    public static final StatusCode INVALID_OAUTH_URL = new StatusCode(_INVALID_OAUTH_URL);
    ...
    public static final StatusCode INVALID_OWNER = new StatusCode(_INVALID_OWNER);
    public static final StatusCode INVALID_PACKAGE_VERSION = new StatusCode(_INVALID_PACKAGE_VERSION);
    ...
    public static final StatusCode INVALID_QUERY_LOCATOR = new StatusCode(_INVALID_QUERY_LOCATOR);
    ...
    public static final StatusCode INVALID_SIGNUP_COUNTRY = new StatusCode(_INVALID_SIGNUP_COUNTRY);
    public static final StatusCode INVALID_STATUS = new StatusCode(_INVALID_STATUS);
    public static final StatusCode INVALID_SUBDOMAIN = new StatusCode(_INVALID_SUBDOMAIN);
    ...
    public static final StatusCode NO_SUCH_USER_EXISTS = new StatusCode(_NO_SUCH_USER_EXISTS);
    ...
    public static final StatusCode PACKAGING_API_INSTALL_FAILED = new StatusCode(_PACKAGING_API_INSTALL_FAILED);
    public static final StatusCode PACKAGING_API_UNINSTALL_FAILED = new StatusCode(_PACKAGING_API_UNINSTALL_FAILED);
    ...
    public static final StatusCode QUERY_TIMEOUT = new StatusCode(_QUERY_TIMEOUT);
    ...
    public static final StatusCode SELF_REFERENCE_FROM_FLOW = new StatusCode(_SELF_REFERENCE_FROM_FLOW);
    ...
    public static final StatusCode SUBDOMAIN_IN_USE = new StatusCode(_SUBDOMAIN_IN_USE);
    ...
    public static final StatusCode TEMPLATE_NOT_FOUND = new StatusCode(_TEMPLATE_NOT_FOUND);
    ...
    public static final StatusCode TOO_MANY_POSSIBLE_USERS_EXIST = new StatusCode(_TOO_MANY_POSSIBLE_USERS_EXIST);
    ...
    public static final StatusCode WEBLINK_URL_INVALID = new StatusCode(_WEBLINK_URL_INVALID);

...
public class StatusCode implements java.io.Serializable {
    ...
    public static final java.lang.String _APEX_DATA_ACCESS_RESTRICTION = "APEX_DATA_ACCESS_RESTRICTION";
    public static final java.lang.String _ASSIGNEE_TYPE_REQUIRED = "ASSIGNEE_TYPE_REQUIRED";
    public static final java.lang.String _AURA_COMPILE_ERROR = "AURA_COMPILE_ERROR";
    ...
    public static final java.lang.String _CANNOT_DELETE_GLOBAL_ACTION_LIST = "CANNOT_DELETE_GLOBAL_ACTION_LIST";
    ...
    public static final java.lang.String _CANNOT_POST_TO_ARCHIVED_GROUP = "CANNOT_POST_TO_ARCHIVED_GROUP";
    ...
    public static final java.lang.String _CLEAN_SERVICE_ERROR = "CLEAN_SERVICE_ERROR";
    ...
    public static final java.lang.String _CONFLICTING_ENVIRONMENT_HUB_MEMBER = "CONFLICTING_ENVIRONMENT_HUB_MEMBER";
    public static final java.lang.String _CONFLICTING_SSO_USER_MAPPING = "CONFLICTING_SSO_USER_MAPPING";
    ...
    public static final java.lang.String _CUSTOM_METADATA_REL_FIELD_MANAGEABILITY = "CUSTOM_METADATA_REL_FIELD_MANAGEABILITY";
    ...
    public static final java.lang.String _DATACLOUDADDRESS_NO_RECORDS_FOUND = "DATACLOUDADDRESS_NO_RECORDS_FOUND";
    public static final java.lang.String _DATACLOUDADDRESS_PROCESSING_ERROR = "DATACLOUDADDRESS_PROCESSING_ERROR";
    public static final java.lang.String _DATACLOUDADDRESS_SERVER_ERROR = "DATACLOUDADDRESS_SERVER_ERROR";
    ...
    public static final java.lang.String _DUPLICATES_DETECTED = "DUPLICATES_DETECTED";
    ...
    public static final java.lang.String _EMAIL_ADDRESS_BOUNCED = "EMAIL_ADDRESS_BOUNCED";
    public static final java.lang.String _EMAIL_EXTERNAL_TRANSPORT_CONNECTION_ERROR = "EMAIL_EXTERNAL_TRANSPORT_CONNECTION_ERROR";
    public static final java.lang.String _EMAIL_EXTERNAL_TRANSPORT_PERMISSION_ERROR = "EMAIL_EXTERNAL_TRANSPORT_PERMISSION_ERROR";
    public static final java.lang.String _EMAIL_EXTERNAL_TRANSPORT_TOKEN_ERROR = "EMAIL_EXTERNAL_TRANSPORT_TOKEN_ERROR";
    public static final java.lang.String _EMAIL_EXTERNAL_TRANSPORT_TOO_MANY_REQUESTS_ERROR = "EMAIL_EXTERNAL_TRANSPORT_TOO_MANY_REQUESTS_ERROR";
    public static final java.lang.String _EMAIL_EXTERNAL_TRANSPORT_UNKNOWN_ERROR = "EMAIL_EXTERNAL_TRANSPORT_UNKNOWN_ERROR";
    public static final java.lang.String _EMAIL_NOT_PROCESSED_DUE_TO_PRIOR_ERROR = "EMAIL_NOT_PROCESSED_DUE_TO_PRIOR_ERROR";
    public static final java.lang.String _EMAIL_OPTED_OUT = "EMAIL_OPTED_OUT";
    public static final java.lang.String _EMAIL_TEMPLATE_FORMULA_ERROR = "EMAIL_TEMPLATE_FORMULA_ERROR";
    public static final java.lang.String _EMAIL_TEMPLATE_MERGEFIELD_ACCESS_ERROR = "EMAIL_TEMPLATE_MERGEFIELD_ACCESS_ERROR";
    public static final java.lang.String _EMAIL_TEMPLATE_MERGEFIELD_ERROR = "EMAIL_TEMPLATE_MERGEFIELD_ERROR";
    public static final java.lang.String _EMAIL_TEMPLATE_MERGEFIELD_VALUE_ERROR = "EMAIL_TEMPLATE_MERGEFIELD_VALUE_ERROR";
    public static final java.lang.String _EMAIL_TEMPLATE_PROCESSING_ERROR = "EMAIL_TEMPLATE_PROCESSING_ERROR";
    ...
    public static final java.lang.String _ENTITY_SAVE_ERROR = "ENTITY_SAVE_ERROR";
    public static final java.lang.String _ENTITY_SAVE_VALIDATION_ERROR = "ENTITY_SAVE_VALIDATION_ERROR";
    ...
    public static final java.lang.String _EXCHANGE_WEB_SERVICES_URL_INVALID = "EXCHANGE_WEB_SERVICES_URL_INVALID";
    ...
    public static final java.lang.String _FIELD_KEYWORD_LIST_MATCH_LIMIT = "FIELD_KEYWORD_LIST_MATCH_LIMIT";
    public static final java.lang.String _FIELD_MAPPING_ERROR = "FIELD_MAPPING_ERROR";
    public static final java.lang.String _FIELD_MODERATION_RULE_BLOCK = "FIELD_MODERATION_RULE_BLOCK";
    public static final java.lang.String _FIELD_NOT_UPDATABLE = "FIELD_NOT_UPDATABLE";
    public static final java.lang.String _FILE_EXTENSION_NOT_ALLOWED = "FILE_EXTENSION_NOT_ALLOWED";
    public static final java.lang.String _FILE_SIZE_LIMIT_EXCEEDED = "FILE_SIZE_LIMIT_EXCEEDED";
    public static final java.lang.String _FILTERED_LOOKUP_LIMIT_EXCEEDED = "FILTERED_LOOKUP_LIMIT_EXCEEDED";
    public static final java.lang.String _FIND_DUPLICATES_ERROR = "FIND_DUPLICATES_ERROR";
    public static final java.lang.String _FUNCTIONALITY_NOT_ENABLED = "FUNCTIONALITY_NOT_ENABLED";
    public static final java.lang.String _HAS_PUBLIC_REFERENCES = "HAS_PUBLIC_REFERENCES";
    ...
    public static final java.lang.String _INACTIVE_RULE_ERROR = "INACTIVE_RULE_ERROR";
    ...
    public static final java.lang.String _INSUFFICIENT_ACCESS_TO_INSIGHTSEXTERNALDATA = "INSUFFICIENT_ACCESS_TO_INSIGHTSEXTERNALDATA";
    public static final java.lang.String _INSUFFICIENT_CREDITS = "INSUFFICIENT_CREDITS";
    ...
    public static final java.lang.String _INVALID_ACCESS_TOKEN = "INVALID_ACCESS_TOKEN";
    ...
    public static final java.lang.String _INVALID_ENTITY_FOR_MATCH_ENGINE_ERROR = "INVALID_ENTITY_FOR_MATCH_ENGINE_ERROR";
    public static final java.lang.String _INVALID_ENTITY_FOR_MATCH_OPERATION_ERROR = "INVALID_ENTITY_FOR_MATCH_OPERATION_ERROR";
    public static final java.lang.String _INVALID_ENTITY_FOR_UPSERT = "INVALID_ENTITY_FOR_UPSERT";
    public static final java.lang.String _INVALID_ENVIRONMENT_HUB_MEMBER = "INVALID_ENVIRONMENT_HUB_MEMBER";
    public static final java.lang.String _INVALID_EVENT_DELIVERY = "INVALID_EVENT_DELIVERY";
    public static final java.lang.String _INVALID_EVENT_SUBSCRIPTION = "INVALID_EVENT_SUBSCRIPTION";
    ...
    public static final java.lang.String _INVALID_MARKUP = "INVALID_MARKUP";
    ...
    public static final java.lang.String _INVALID_NAMESPACE_PREFIX = "INVALID_NAMESPACE_PREFIX";
    ...
    public static final java.lang.String _INVALID_PACKAGE_LICENSE = "INVALID_PACKAGE_LICENSE";
    ...
    public static final java.lang.String _INVALID_PROVIDER_TYPE = "INVALID_PROVIDER_TYPE";
    ...
    public static final java.lang.String _INVALID_REFRESH_TOKEN = "INVALID_REFRESH_TOKEN";
    public static final java.lang.String _INVALID_RUNTIME_VALUE = "INVALID_RUNTIME_VALUE";
    ...
    public static final java.lang.String _INVALID_SIGNUP_OPTION = "INVALID_SIGNUP_OPTION";
    public static final java.lang.String _INVALID_SITE_DELETE_EXCEPTION = "INVALID_SITE_DELETE_EXCEPTION";
    public static final java.lang.String _INVALID_SITE_FILE_IMPORTED_EXCEPTION = "INVALID_SITE_FILE_IMPORTED_EXCEPTION";
    public static final java.lang.String _INVALID_SITE_FILE_TYPE_EXCEPTION = "INVALID_SITE_FILE_TYPE_EXCEPTION";
    ...
    public static final java.lang.String _INVALID_USERID = "INVALID_USERID";
    ...
    public static final java.lang.String _MATCH_DEFINITION_ERROR = "MATCH_DEFINITION_ERROR";
    public static final java.lang.String _MATCH_OPERATION_ERROR = "MATCH_OPERATION_ERROR";
    public static final java.lang.String _MATCH_OPERATION_INVALID_ENGINE_ERROR = "MATCH_OPERATION_INVALID_ENGINE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_INVALID_RULE_ERROR = "MATCH_OPERATION_INVALID_RULE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_MISSING_ENGINE_ERROR = "MATCH_OPERATION_MISSING_ENGINE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_MISSING_OBJECT_TYPE_ERROR = "MATCH_OPERATION_MISSING_OBJECT_TYPE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_MISSING_OPTIONS_ERROR = "MATCH_OPERATION_MISSING_OPTIONS_ERROR";
    public static final java.lang.String _MATCH_OPERATION_MISSING_RULE_ERROR = "MATCH_OPERATION_MISSING_RULE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_UNKNOWN_RULE_ERROR = "MATCH_OPERATION_UNKNOWN_RULE_ERROR";
    public static final java.lang.String _MATCH_OPERATION_UNSUPPORTED_VERSION_ERROR = "MATCH_OPERATION_UNSUPPORTED_VERSION_ERROR";
    public static final java.lang.String _MATCH_PRECONDITION_FAILED = "MATCH_PRECONDITION_FAILED";
    public static final java.lang.String _MATCH_RUNTIME_ERROR = "MATCH_RUNTIME_ERROR";
    public static final java.lang.String _MATCH_SERVICE_ERROR = "MATCH_SERVICE_ERROR";
    public static final java.lang.String _MATCH_SERVICE_TIMED_OUT = "MATCH_SERVICE_TIMED_OUT";
    public static final java.lang.String _MATCH_SERVICE_UNAVAILABLE_ERROR = "MATCH_SERVICE_UNAVAILABLE_ERROR";
    ...
    public static final java.lang.String _MAXIMUM_HIERARCHY_CHILDREN_REACHED = "MAXIMUM_HIERARCHY_CHILDREN_REACHED";
    public static final java.lang.String _MAXIMUM_HIERARCHY_LEVELS_REACHED = "MAXIMUM_HIERARCHY_LEVELS_REACHED";
    public static final java.lang.String _MAXIMUM_HIERARCHY_TREE_SIZE_REACHED = "MAXIMUM_HIERARCHY_TREE_SIZE_REACHED";
    ...
    public static final java.lang.String _MAX_DEPTH_IN_FLOW_EXECUTION = "MAX_DEPTH_IN_FLOW_EXECUTION";
    ...
    public static final java.lang.String _MAX_TRIGGERS_EXCEEDED = "MAX_TRIGGERS_EXCEEDED";
    public static final java.lang.String _MERGE_FAILED = "MERGE_FAILED";
    public static final java.lang.String _METADATA_FIELD_UPDATE_ERROR = "METADATA_FIELD_UPDATE_ERROR";
    ...
    public static final java.lang.String _NO_ACCESS_TOKEN = "NO_ACCESS_TOKEN";
    public static final java.lang.String _NO_ACCESS_TOKEN_FROM_REFRESH = "NO_ACCESS_TOKEN_FROM_REFRESH";
    ...
    public static final java.lang.String _NO_AUTH_PROVIDER = "NO_AUTH_PROVIDER";
    ...
    public static final java.lang.String _NO_PARTNER_PERMISSION = "NO_PARTNER_PERMISSION";
    public static final java.lang.String _NO_REFRESH_TOKEN = "NO_REFRESH_TOKEN";
    public static final java.lang.String _NO_SUCH_USER_EXISTS = "NO_SUCH_USER_EXISTS";
    public static final java.lang.String _NO_TOKEN_ENDPOINT = "NO_TOKEN_ENDPOINT";
    ...
    public static final java.lang.String _PALI_INVALID_ACTION_ID = "PALI_INVALID_ACTION_ID";
    public static final java.lang.String _PALI_INVALID_ACTION_NAME = "PALI_INVALID_ACTION_NAME";
    public static final java.lang.String _PALI_INVALID_ACTION_TYPE = "PALI_INVALID_ACTION_TYPE";
    public static final java.lang.String _PAL_INVALID_ASSISTANT_RECOMMENDATION_TYPE_ID = "PAL_INVALID_ASSISTANT_RECOMMENDATION_TYPE_ID";
    public static final java.lang.String _PAL_INVALID_ENTITY_ID = "PAL_INVALID_ENTITY_ID";
    public static final java.lang.String _PAL_INVALID_FLEXIPAGE_ID = "PAL_INVALID_FLEXIPAGE_ID";
    public static final java.lang.String _PAL_INVALID_LAYOUT_ID = "PAL_INVALID_LAYOUT_ID";
    public static final java.lang.String _PAL_INVALID_PARAMETERS = "PAL_INVALID_PARAMETERS";
    public static final java.lang.String _PA_API_EXCEPTION = "PA_API_EXCEPTION";
    public static final java.lang.String _PA_AXIS_FAULT = "PA_AXIS_FAULT";
    public static final java.lang.String _PA_INVALID_ID_EXCEPTION = "PA_INVALID_ID_EXCEPTION";
    public static final java.lang.String _PA_NO_ACCESS_EXCEPTION = "PA_NO_ACCESS_EXCEPTION";
    public static final java.lang.String _PA_NO_DATA_FOUND_EXCEPTION = "PA_NO_DATA_FOUND_EXCEPTION";
    public static final java.lang.String _PA_URI_SYNTAX_EXCEPTION = "PA_URI_SYNTAX_EXCEPTION";
    public static final java.lang.String _PA_VISIBLE_ACTIONS_FILTER_ORDERING_EXCEPTION = "PA_VISIBLE_ACTIONS_FILTER_ORDERING_EXCEPTION";
    ...
    public static final java.lang.String _PORTAL_USER_CREATION_RESTRICTED_WITH_ENCRYPTION = "PORTAL_USER_CREATION_RESTRICTED_WITH_ENCRYPTION";
    public static final java.lang.String _PRIVATE_CONTACT_ON_ASSET = "PRIVATE_CONTACT_ON_ASSET";
    public static final java.lang.String _PROCESSING_HALTED = "PROCESSING_HALTED";
    public static final java.lang.String _QA_INVALID_CREATE_FEED_ITEM = "QA_INVALID_CREATE_FEED_ITEM";
    public static final java.lang.String _QA_INVALID_SUCCESS_MESSAGE = "QA_INVALID_SUCCESS_MESSAGE";
    public static final java.lang.String _QUERY_TIMEOUT = "QUERY_TIMEOUT";
    public static final java.lang.String _QUICK_ACTION_LIST_ITEM_NOT_ALLOWED = "QUICK_ACTION_LIST_ITEM_NOT_ALLOWED";
    public static final java.lang.String _QUICK_ACTION_LIST_NOT_ALLOWED = "QUICK_ACTION_LIST_NOT_ALLOWED";
    public static final java.lang.String _RECORD_IN_USE_BY_WORKFLOW = "RECORD_IN_USE_BY_WORKFLOW";
    public static final java.lang.String _REL_FIELD_BAD_ACCESSIBILITY = "REL_FIELD_BAD_ACCESSIBILITY";
    public static final java.lang.String _REPUTATION_MINIMUM_NUMBER_NOT_REACHED = "REPUTATION_MINIMUM_NUMBER_NOT_REACHED";
    ...
    public static final java.lang.String _RETRIEVE_EXCHANGE_ATTACHMENT_FAILED = "RETRIEVE_EXCHANGE_ATTACHMENT_FAILED";
    public static final java.lang.String _RETRIEVE_EXCHANGE_EMAIL_FAILED = "RETRIEVE_EXCHANGE_EMAIL_FAILED";
    public static final java.lang.String _RETRIEVE_EXCHANGE_EVENT_FAILED = "RETRIEVE_EXCHANGE_EVENT_FAILED";
    public static final java.lang.String _RETRIEVE_GOOGLE_EMAIL_FAILED = "RETRIEVE_GOOGLE_EMAIL_FAILED";
    public static final java.lang.String _RETRIEVE_GOOGLE_EVENT_FAILED = "RETRIEVE_GOOGLE_EVENT_FAILED";
    public static final java.lang.String _SALESFORCE_INBOX_TRANSPORT_CONNECTION_ERROR = "SALESFORCE_INBOX_TRANSPORT_CONNECTION_ERROR";
    public static final java.lang.String _SALESFORCE_INBOX_TRANSPORT_TOKEN_ERROR = "SALESFORCE_INBOX_TRANSPORT_TOKEN_ERROR";
    public static final java.lang.String _SALESFORCE_INBOX_TRANSPORT_UNKNOWN_ERROR = "SALESFORCE_INBOX_TRANSPORT_UNKNOWN_ERROR";
    ...
    public static final java.lang.String _SOCIAL_ACCOUNT_NOT_FOUND = "SOCIAL_ACCOUNT_NOT_FOUND";
    public static final java.lang.String _SOCIAL_ACTION_INVALID = "SOCIAL_ACTION_INVALID";
    public static final java.lang.String _SOCIAL_POST_INVALID = "SOCIAL_POST_INVALID";
    public static final java.lang.String _SOCIAL_POST_NOT_FOUND = "SOCIAL_POST_NOT_FOUND";
    ...
    public static final java.lang.String _TERMS_OF_SERVICE_UNREAD = "TERMS_OF_SERVICE_UNREAD";
    ...
    public static final java.lang.String _UNAVAILABLE_REF = "UNAVAILABLE_REF";
    ...
    public static final java.lang.String _UNKNOWN_TOKEN_ERROR = "UNKNOWN_TOKEN_ERROR";
    public static final java.lang.String _UNSAFE_HTML_CONTENT = "UNSAFE_HTML_CONTENT";
    ...
    public static final java.lang.String _VF_COMPILE_ERROR = "VF_COMPILE_ERROR";
    ...
    public static final java.lang.String _XCLEAN_UNEXPECTED_ERROR = "XCLEAN_UNEXPECTED_ERROR";
    ...
    public static final StatusCode APEX_DATA_ACCESS_RESTRICTION = new StatusCode(_APEX_DATA_ACCESS_RESTRICTION);
    public static final StatusCode ASSIGNEE_TYPE_REQUIRED = new StatusCode(_ASSIGNEE_TYPE_REQUIRED);
    public static final StatusCode AURA_COMPILE_ERROR = new StatusCode(_AURA_COMPILE_ERROR);
    ...
    public static final StatusCode CANNOT_DELETE_GLOBAL_ACTION_LIST = new StatusCode(_CANNOT_DELETE_GLOBAL_ACTION_LIST);
    ...
    public static final StatusCode CANNOT_POST_TO_ARCHIVED_GROUP = new StatusCode(_CANNOT_POST_TO_ARCHIVED_GROUP);
    ...
    public static final StatusCode CLEAN_SERVICE_ERROR = new StatusCode(_CLEAN_SERVICE_ERROR);
    ...
    public static final StatusCode CONFLICTING_ENVIRONMENT_HUB_MEMBER = new StatusCode(_CONFLICTING_ENVIRONMENT_HUB_MEMBER);
    public static final StatusCode CONFLICTING_SSO_USER_MAPPING = new StatusCode(_CONFLICTING_SSO_USER_MAPPING);
    ...
    public static final StatusCode CUSTOM_METADATA_REL_FIELD_MANAGEABILITY = new StatusCode(_CUSTOM_METADATA_REL_FIELD_MANAGEABILITY);
    public static final StatusCode CUSTOM_SETTINGS_LIMIT_EXCEEDED = new StatusCode(_CUSTOM_SETTINGS_LIMIT_EXCEEDED);
    public static final StatusCode CUSTOM_TAB_LIMIT_EXCEEDED = new StatusCode(_CUSTOM_TAB_LIMIT_EXCEEDED);
    public static final StatusCode DATACLOUDADDRESS_NO_RECORDS_FOUND = new StatusCode(_DATACLOUDADDRESS_NO_RECORDS_FOUND);
    public static final StatusCode DATACLOUDADDRESS_PROCESSING_ERROR = new StatusCode(_DATACLOUDADDRESS_PROCESSING_ERROR);
    public static final StatusCode DATACLOUDADDRESS_SERVER_ERROR = new StatusCode(_DATACLOUDADDRESS_SERVER_ERROR);
    ...
    public static final StatusCode DUPLICATES_DETECTED = new StatusCode(_DUPLICATES_DETECTED);
    ...
    public static final StatusCode EMAIL_ADDRESS_BOUNCED = new StatusCode(_EMAIL_ADDRESS_BOUNCED);
    public static final StatusCode EMAIL_EXTERNAL_TRANSPORT_CONNECTION_ERROR = new StatusCode(_EMAIL_EXTERNAL_TRANSPORT_CONNECTION_ERROR);
    public static final StatusCode EMAIL_EXTERNAL_TRANSPORT_PERMISSION_ERROR = new StatusCode(_EMAIL_EXTERNAL_TRANSPORT_PERMISSION_ERROR);
    public static final StatusCode EMAIL_EXTERNAL_TRANSPORT_TOKEN_ERROR = new StatusCode(_EMAIL_EXTERNAL_TRANSPORT_TOKEN_ERROR);
    public static final StatusCode EMAIL_EXTERNAL_TRANSPORT_TOO_MANY_REQUESTS_ERROR = new StatusCode(_EMAIL_EXTERNAL_TRANSPORT_TOO_MANY_REQUESTS_ERROR);
    public static final StatusCode EMAIL_EXTERNAL_TRANSPORT_UNKNOWN_ERROR = new StatusCode(_EMAIL_EXTERNAL_TRANSPORT_UNKNOWN_ERROR);
    ...
    public static final StatusCode EMAIL_OPTED_OUT = new StatusCode(_EMAIL_OPTED_OUT);
    public static final StatusCode EMAIL_TEMPLATE_FORMULA_ERROR = new StatusCode(_EMAIL_TEMPLATE_FORMULA_ERROR);
    public static final StatusCode EMAIL_TEMPLATE_MERGEFIELD_ACCESS_ERROR = new StatusCode(_EMAIL_TEMPLATE_MERGEFIELD_ACCESS_ERROR);
    public static final StatusCode EMAIL_TEMPLATE_MERGEFIELD_ERROR = new StatusCode(_EMAIL_TEMPLATE_MERGEFIELD_ERROR);
    public static final StatusCode EMAIL_TEMPLATE_MERGEFIELD_VALUE_ERROR = new StatusCode(_EMAIL_TEMPLATE_MERGEFIELD_VALUE_ERROR);
    public static final StatusCode EMAIL_TEMPLATE_PROCESSING_ERROR = new StatusCode(_EMAIL_TEMPLATE_PROCESSING_ERROR);
    ...
    public static final StatusCode ENTITY_SAVE_ERROR = new StatusCode(_ENTITY_SAVE_ERROR);
    public static final StatusCode ENTITY_SAVE_VALIDATION_ERROR = new StatusCode(_ENTITY_SAVE_VALIDATION_ERROR);
    ...
    public static final StatusCode EXCHANGE_WEB_SERVICES_URL_INVALID = new StatusCode(_EXCHANGE_WEB_SERVICES_URL_INVALID);
    ...
    public static final StatusCode FIELD_KEYWORD_LIST_MATCH_LIMIT = new StatusCode(_FIELD_KEYWORD_LIST_MATCH_LIMIT);
    public static final StatusCode FIELD_MAPPING_ERROR = new StatusCode(_FIELD_MAPPING_ERROR);
    public static final StatusCode FIELD_MODERATION_RULE_BLOCK = new StatusCode(_FIELD_MODERATION_RULE_BLOCK);
    public static final StatusCode FIELD_NOT_UPDATABLE = new StatusCode(_FIELD_NOT_UPDATABLE);
    public static final StatusCode FILE_EXTENSION_NOT_ALLOWED = new StatusCode(_FILE_EXTENSION_NOT_ALLOWED);
    public static final StatusCode FILE_SIZE_LIMIT_EXCEEDED = new StatusCode(_FILE_SIZE_LIMIT_EXCEEDED);
    public static final StatusCode FILTERED_LOOKUP_LIMIT_EXCEEDED = new StatusCode(_FILTERED_LOOKUP_LIMIT_EXCEEDED);
    public static final StatusCode FIND_DUPLICATES_ERROR = new StatusCode(_FIND_DUPLICATES_ERROR);
    public static final StatusCode FUNCTIONALITY_NOT_ENABLED = new StatusCode(_FUNCTIONALITY_NOT_ENABLED);
    public static final StatusCode HAS_PUBLIC_REFERENCES = new StatusCode(_HAS_PUBLIC_REFERENCES);
    ...
    public static final StatusCode INACTIVE_RULE_ERROR = new StatusCode(_INACTIVE_RULE_ERROR);
    public static final StatusCode INSERT_UPDATE_DELETE_NOT_ALLOWED_DURING_MAINTENANCE = new StatusCode(_INSERT_UPDATE_DELETE_NOT_ALLOWED_DURING_MAINTENANCE);
    ...
    public static final StatusCode INSUFFICIENT_ACCESS_TO_INSIGHTSEXTERNALDATA = new StatusCode(_INSUFFICIENT_ACCESS_TO_INSIGHTSEXTERNALDATA);
    public static final StatusCode INSUFFICIENT_CREDITS = new StatusCode(_INSUFFICIENT_CREDITS);
    public static final StatusCode INTERNAL_ERROR = new StatusCode(_INTERNAL_ERROR);
    public static final StatusCode INVALID_ACCESS_LEVEL = new StatusCode(_INVALID_ACCESS_LEVEL);
    public static final StatusCode INVALID_ACCESS_TOKEN = new StatusCode(_INVALID_ACCESS_TOKEN);
    ...
    public static final StatusCode INVALID_ENTITY_FOR_MATCH_ENGINE_ERROR = new StatusCode(_INVALID_ENTITY_FOR_MATCH_ENGINE_ERROR);
    public static final StatusCode INVALID_ENTITY_FOR_MATCH_OPERATION_ERROR = new StatusCode(_INVALID_ENTITY_FOR_MATCH_OPERATION_ERROR);
    public static final StatusCode INVALID_ENTITY_FOR_UPSERT = new StatusCode(_INVALID_ENTITY_FOR_UPSERT);
    public static final StatusCode INVALID_ENVIRONMENT_HUB_MEMBER = new StatusCode(_INVALID_ENVIRONMENT_HUB_MEMBER);
    public static final StatusCode INVALID_EVENT_DELIVERY = new StatusCode(_INVALID_EVENT_DELIVERY);
    public static final StatusCode INVALID_EVENT_SUBSCRIPTION = new StatusCode(_INVALID_EVENT_SUBSCRIPTION);
    ...
    public static final StatusCode INVALID_INPUT = new StatusCode(_INVALID_INPUT);
    public static final StatusCode INVALID_LINEITEM_CLONE_STATE = new StatusCode(_INVALID_LINEITEM_CLONE_STATE);
    public static final StatusCode INVALID_MARKUP = new StatusCode(_INVALID_MARKUP);
    ...
    public static final StatusCode INVALID_NAMESPACE_PREFIX = new StatusCode(_INVALID_NAMESPACE_PREFIX);
    ...
    public static final StatusCode INVALID_PACKAGE_LICENSE = new StatusCode(_INVALID_PACKAGE_LICENSE);
    ...
    public static final StatusCode INVALID_PROVIDER_TYPE = new StatusCode(_INVALID_PROVIDER_TYPE);
    ...
    public static final StatusCode INVALID_REFRESH_TOKEN = new StatusCode(_INVALID_REFRESH_TOKEN);
    public static final StatusCode INVALID_RUNTIME_VALUE = new StatusCode(_INVALID_RUNTIME_VALUE);
    ...
    public static final StatusCode INVALID_SIGNUP_OPTION = new StatusCode(_INVALID_SIGNUP_OPTION);
    public static final StatusCode INVALID_SITE_DELETE_EXCEPTION = new StatusCode(_INVALID_SITE_DELETE_EXCEPTION);
    public static final StatusCode INVALID_SITE_FILE_IMPORTED_EXCEPTION = new StatusCode(_INVALID_SITE_FILE_IMPORTED_EXCEPTION);
    public static final StatusCode INVALID_SITE_FILE_TYPE_EXCEPTION = new StatusCode(_INVALID_SITE_FILE_TYPE_EXCEPTION);
    ...
    public static final StatusCode INVALID_USERID = new StatusCode(_INVALID_USERID);
    public static final StatusCode IP_RANGE_LIMIT_EXCEEDED = new StatusCode(_IP_RANGE_LIMIT_EXCEEDED);
    public static final StatusCode JIGSAW_IMPORT_LIMIT_EXCEEDED = new StatusCode(_JIGSAW_IMPORT_LIMIT_EXCEEDED);
    ...
    public static final StatusCode MATCH_DEFINITION_ERROR = new StatusCode(_MATCH_DEFINITION_ERROR);
    public static final StatusCode MATCH_OPERATION_ERROR = new StatusCode(_MATCH_OPERATION_ERROR);
    public static final StatusCode MATCH_OPERATION_INVALID_ENGINE_ERROR = new StatusCode(_MATCH_OPERATION_INVALID_ENGINE_ERROR);
    public static final StatusCode MATCH_OPERATION_INVALID_RULE_ERROR = new StatusCode(_MATCH_OPERATION_INVALID_RULE_ERROR);
    public static final StatusCode MATCH_OPERATION_MISSING_ENGINE_ERROR = new StatusCode(_MATCH_OPERATION_MISSING_ENGINE_ERROR);
    public static final StatusCode MATCH_OPERATION_MISSING_OBJECT_TYPE_ERROR = new StatusCode(_MATCH_OPERATION_MISSING_OBJECT_TYPE_ERROR);
    public static final StatusCode MATCH_OPERATION_MISSING_OPTIONS_ERROR = new StatusCode(_MATCH_OPERATION_MISSING_OPTIONS_ERROR);
    public static final StatusCode MATCH_OPERATION_MISSING_RULE_ERROR = new StatusCode(_MATCH_OPERATION_MISSING_RULE_ERROR);
    public static final StatusCode MATCH_OPERATION_UNKNOWN_RULE_ERROR = new StatusCode(_MATCH_OPERATION_UNKNOWN_RULE_ERROR);
    public static final StatusCode MATCH_OPERATION_UNSUPPORTED_VERSION_ERROR = new StatusCode(_MATCH_OPERATION_UNSUPPORTED_VERSION_ERROR);
    public static final StatusCode MATCH_PRECONDITION_FAILED = new StatusCode(_MATCH_PRECONDITION_FAILED);
    public static final StatusCode MATCH_RUNTIME_ERROR = new StatusCode(_MATCH_RUNTIME_ERROR);
    public static final StatusCode MATCH_SERVICE_ERROR = new StatusCode(_MATCH_SERVICE_ERROR);
    public static final StatusCode MATCH_SERVICE_TIMED_OUT = new StatusCode(_MATCH_SERVICE_TIMED_OUT);
    public static final StatusCode MATCH_SERVICE_UNAVAILABLE_ERROR = new StatusCode(_MATCH_SERVICE_UNAVAILABLE_ERROR);
    ...
    public static final StatusCode MAXIMUM_HIERARCHY_CHILDREN_REACHED = new StatusCode(_MAXIMUM_HIERARCHY_CHILDREN_REACHED);
    public static final StatusCode MAXIMUM_HIERARCHY_LEVELS_REACHED = new StatusCode(_MAXIMUM_HIERARCHY_LEVELS_REACHED);
    public static final StatusCode MAXIMUM_HIERARCHY_TREE_SIZE_REACHED = new StatusCode(_MAXIMUM_HIERARCHY_TREE_SIZE_REACHED);
    ...
    public static final StatusCode MAX_DEPTH_IN_FLOW_EXECUTION = new StatusCode(_MAX_DEPTH_IN_FLOW_EXECUTION);
    ...
    public static final StatusCode MAX_TRIGGERS_EXCEEDED = new StatusCode(_MAX_TRIGGERS_EXCEEDED);
    public static final StatusCode MERGE_FAILED = new StatusCode(_MERGE_FAILED);
    public static final StatusCode METADATA_FIELD_UPDATE_ERROR = new StatusCode(_METADATA_FIELD_UPDATE_ERROR);
    public static final StatusCode MISSING_ARGUMENT = new StatusCode(_MISSING_ARGUMENT);
    public static final StatusCode MISSING_RECORD = new StatusCode(_MISSING_RECORD);
    ...
    public static final StatusCode NO_ACCESS_TOKEN = new StatusCode(_NO_ACCESS_TOKEN);
    public static final StatusCode NO_ACCESS_TOKEN_FROM_REFRESH = new StatusCode(_NO_ACCESS_TOKEN_FROM_REFRESH);
    ...
    public static final StatusCode NO_AUTH_PROVIDER = new StatusCode(_NO_AUTH_PROVIDER);
    ...
    public static final StatusCode NO_PARTNER_PERMISSION = new StatusCode(_NO_PARTNER_PERMISSION);
    public static final StatusCode NO_REFRESH_TOKEN = new StatusCode(_NO_REFRESH_TOKEN);
    public static final StatusCode NO_SUCH_USER_EXISTS = new StatusCode(_NO_SUCH_USER_EXISTS);
    public static final StatusCode NO_TOKEN_ENDPOINT = new StatusCode(_NO_TOKEN_ENDPOINT);
    ...
    public static final StatusCode PALI_INVALID_ACTION_ID = new StatusCode(_PALI_INVALID_ACTION_ID);
    public static final StatusCode PALI_INVALID_ACTION_NAME = new StatusCode(_PALI_INVALID_ACTION_NAME);
    public static final StatusCode PALI_INVALID_ACTION_TYPE = new StatusCode(_PALI_INVALID_ACTION_TYPE);
    public static final StatusCode PAL_INVALID_ASSISTANT_RECOMMENDATION_TYPE_ID = new StatusCode(_PAL_INVALID_ASSISTANT_RECOMMENDATION_TYPE_ID);
    public static final StatusCode PAL_INVALID_ENTITY_ID = new StatusCode(_PAL_INVALID_ENTITY_ID);
    public static final StatusCode PAL_INVALID_FLEXIPAGE_ID = new StatusCode(_PAL_INVALID_FLEXIPAGE_ID);
    public static final StatusCode PAL_INVALID_LAYOUT_ID = new StatusCode(_PAL_INVALID_LAYOUT_ID);
    public static final StatusCode PAL_INVALID_PARAMETERS = new StatusCode(_PAL_INVALID_PARAMETERS);
    public static final StatusCode PA_API_EXCEPTION = new StatusCode(_PA_API_EXCEPTION);
    public static final StatusCode PA_AXIS_FAULT = new StatusCode(_PA_AXIS_FAULT);
    public static final StatusCode PA_INVALID_ID_EXCEPTION = new StatusCode(_PA_INVALID_ID_EXCEPTION);
    public static final StatusCode PA_NO_ACCESS_EXCEPTION = new StatusCode(_PA_NO_ACCESS_EXCEPTION);
    public static final StatusCode PA_NO_DATA_FOUND_EXCEPTION = new StatusCode(_PA_NO_DATA_FOUND_EXCEPTION);
    public static final StatusCode PA_URI_SYNTAX_EXCEPTION = new StatusCode(_PA_URI_SYNTAX_EXCEPTION);
    public static final StatusCode PA_VISIBLE_ACTIONS_FILTER_ORDERING_EXCEPTION = new StatusCode(_PA_VISIBLE_ACTIONS_FILTER_ORDERING_EXCEPTION);
    ...
    public static final StatusCode PORTAL_USER_CREATION_RESTRICTED_WITH_ENCRYPTION = new StatusCode(_PORTAL_USER_CREATION_RESTRICTED_WITH_ENCRYPTION);
    public static final StatusCode PRIVATE_CONTACT_ON_ASSET = new StatusCode(_PRIVATE_CONTACT_ON_ASSET);
    public static final StatusCode PROCESSING_HALTED = new StatusCode(_PROCESSING_HALTED);
    public static final StatusCode QA_INVALID_CREATE_FEED_ITEM = new StatusCode(_QA_INVALID_CREATE_FEED_ITEM);
    public static final StatusCode QA_INVALID_SUCCESS_MESSAGE = new StatusCode(_QA_INVALID_SUCCESS_MESSAGE);
    public static final StatusCode QUERY_TIMEOUT = new StatusCode(_QUERY_TIMEOUT);
    public static final StatusCode QUICK_ACTION_LIST_ITEM_NOT_ALLOWED = new StatusCode(_QUICK_ACTION_LIST_ITEM_NOT_ALLOWED);
    public static final StatusCode QUICK_ACTION_LIST_NOT_ALLOWED = new StatusCode(_QUICK_ACTION_LIST_NOT_ALLOWED);
    public static final StatusCode RECORD_IN_USE_BY_WORKFLOW = new StatusCode(_RECORD_IN_USE_BY_WORKFLOW);
    public static final StatusCode REL_FIELD_BAD_ACCESSIBILITY = new StatusCode(_REL_FIELD_BAD_ACCESSIBILITY);
    public static final StatusCode REPUTATION_MINIMUM_NUMBER_NOT_REACHED = new StatusCode(_REPUTATION_MINIMUM_NUMBER_NOT_REACHED);
    ...
    public static final StatusCode RETRIEVE_EXCHANGE_ATTACHMENT_FAILED = new StatusCode(_RETRIEVE_EXCHANGE_ATTACHMENT_FAILED);
    public static final StatusCode RETRIEVE_EXCHANGE_EMAIL_FAILED = new StatusCode(_RETRIEVE_EXCHANGE_EMAIL_FAILED);
    public static final StatusCode RETRIEVE_EXCHANGE_EVENT_FAILED = new StatusCode(_RETRIEVE_EXCHANGE_EVENT_FAILED);
    public static final StatusCode RETRIEVE_GOOGLE_EMAIL_FAILED = new StatusCode(_RETRIEVE_GOOGLE_EMAIL_FAILED);
    public static final StatusCode RETRIEVE_GOOGLE_EVENT_FAILED = new StatusCode(_RETRIEVE_GOOGLE_EVENT_FAILED);
    public static final StatusCode SALESFORCE_INBOX_TRANSPORT_CONNECTION_ERROR = new StatusCode(_SALESFORCE_INBOX_TRANSPORT_CONNECTION_ERROR);
    public static final StatusCode SALESFORCE_INBOX_TRANSPORT_TOKEN_ERROR = new StatusCode(_SALESFORCE_INBOX_TRANSPORT_TOKEN_ERROR);
    public static final StatusCode SALESFORCE_INBOX_TRANSPORT_UNKNOWN_ERROR = new StatusCode(_SALESFORCE_INBOX_TRANSPORT_UNKNOWN_ERROR);
    ...
    public static final StatusCode SOCIAL_ACCOUNT_NOT_FOUND = new StatusCode(_SOCIAL_ACCOUNT_NOT_FOUND);
    public static final StatusCode SOCIAL_ACTION_INVALID = new StatusCode(_SOCIAL_ACTION_INVALID);
    public static final StatusCode SOCIAL_POST_INVALID = new StatusCode(_SOCIAL_POST_INVALID);
    public static final StatusCode SOCIAL_POST_NOT_FOUND = new StatusCode(_SOCIAL_POST_NOT_FOUND);
    ...
    public static final StatusCode TERMS_OF_SERVICE_UNREAD = new StatusCode(_TERMS_OF_SERVICE_UNREAD);
    ...
    public static final StatusCode UNAVAILABLE_REF = new StatusCode(_UNAVAILABLE_REF);
    ...
    public static final StatusCode UNKNOWN_TOKEN_ERROR = new StatusCode(_UNKNOWN_TOKEN_ERROR);
    public static final StatusCode UNSAFE_HTML_CONTENT = new StatusCode(_UNSAFE_HTML_CONTENT);
    ...
    public static final StatusCode VF_COMPILE_ERROR = new StatusCode(_VF_COMPILE_ERROR);
    ...
    public static final StatusCode XCLEAN_UNEXPECTED_ERROR = new StatusCode(_XCLEAN_UNEXPECTED_ERROR);

...
public class LogInfo  implements java.io.Serializable {
    private com.sforce.soap.partner.LogCategory category;

    private com.sforce.soap.partner.LogCategoryLevel level;

    public LogInfo() {
    }

    public LogInfo(
           com.sforce.soap.partner.LogCategory category,
           com.sforce.soap.partner.LogCategoryLevel level) {
     ...
     * @return category
     */
    public com.sforce.soap.partner.LogCategory getCategory() {
        return category;
    }
     ...
     * @param category
     */
    public void setCategory(com.sforce.soap.partner.LogCategory category) {
        this.category = category;
    }
     ...
     * @return level
     */
    public com.sforce.soap.partner.LogCategoryLevel getLevel() {
        return level;
    }
     ...
     * @param level
     */
    public void setLevel(com.sforce.soap.partner.LogCategoryLevel level) {
        this.level = level;
    }

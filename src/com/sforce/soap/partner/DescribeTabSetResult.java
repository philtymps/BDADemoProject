...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    /**
     * Gets the tabSetId value for this DescribeTabSetResult.
     * 
     * @return tabSetId
     */
    ...
    /**
     * Sets the tabSetId value for this DescribeTabSetResult.
     * 
     * @param tabSetId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.tabSetId==null && other.getTabSetId()==null) || 
             (this.tabSetId!=null &&
              this.tabSetId.equals(other.getTabSetId()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getTabSetId() != null) {
            _hashCode += getTabSetId().hashCode();
        }
        if (getTabs() != null) {
            for (int i=0;
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tabSetId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "tabSetId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

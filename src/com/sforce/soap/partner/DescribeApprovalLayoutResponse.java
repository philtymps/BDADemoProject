...
public class DescribeApprovalLayoutResponse  implements java.io.Serializable {
    private com.sforce.soap.partner.DescribeApprovalLayout[] result;

    public DescribeApprovalLayoutResponse() {
    }

    public DescribeApprovalLayoutResponse(
           com.sforce.soap.partner.DescribeApprovalLayout[] result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce.soap.partner.DescribeApprovalLayout[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce.soap.partner.DescribeApprovalLayout[] result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", ">describeApprovalLayoutResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "DescribeApprovalLayout"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "approvalLayouts"));

...
public class DescribeQuickActionResult  implements java.io.Serializable {
    ...
    public com.sforce.soap.partner.DescribeLayoutSection getLayout(int i) {
        return this.layout[i];
    }

    public void setLayout(int i, com.sforce.soap.partner.DescribeLayoutSection _value) {
        this.layout[i] = _value;
    }
    ...
    /**
     * Gets the sourceSobjectType value for this DescribeQuickActionResult.
     * 
    ...
    /**
     * Sets the sourceSobjectType value for this DescribeQuickActionResult.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.layout==null && other.getLayout()==null) || 
             (this.layout!=null &&
              java.util.Arrays.equals(this.layout, other.getLayout()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getLayout() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLayout());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLayout(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sourceSobjectType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

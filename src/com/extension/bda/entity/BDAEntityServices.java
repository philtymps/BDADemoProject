...
public class BDAEntityServices {
	...
	public static YFCElement getObjectList(YFCElement eInput, String sEntityType) {
		...
		YFCElement response = BDATable.getRecords(search, e);
	...
	public static Document getObjectList(Document docInput, String sEntityType) {
		YFCDocument dInput = YFCDocument.getDocumentFor(docInput);
		YFCElement eInput = dInput.getDocumentElement();
		YFCElement response = getObjectList(eInput, sEntityType);
		if(!YFCCommon.isVoid(response)){

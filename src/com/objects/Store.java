	...
	public static void main(String[] args) throws InterruptedException{
		...
		if(arguments.contains("-file")){
			...
			try {
				...
				String sSql = "SELECT PERSON_INFO_KEY, ADDRESS_LINE1, ADDRESS_LINE2, CITY, STATE, ZIP_CODE, COUNTRY FROM OMDB.YFS_PERSON_INFO WHERE COUNTRY = 'GB' AND LATITUDE IS NULL";
